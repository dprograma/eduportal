    ...
    <div class="row">
        <div class="col-md-12">
            <div class="list-group rounded-0">
                ...
                try {
                    $query = "SELECT * FROM document WHERE document_type='Past Question' AND `published`= 1 LIMIT $limit OFFSET $offset";
                    $search = "SELECT count(*) as total FROM document WHERE document_type='Past Question' AND `published`= 1 LIMIT $limit";
                    if (!empty($subject_name || $exam_body || $subject_year)) {
                        $query = "SELECT * FROM document WHERE document_type='Past Question' AND `subject` LIKE '%$subject_name%' AND `exam_body` LIKE '%$exam_body%' AND `year` LIKE '%$subject_year%' AND `published` = 1  LIMIT $limit";
                        $search = "SELECT count(*) as total from document WHERE document_type='Past Question' AND `subject` LIKE '%$subject_name%' AND `exam_body` LIKE '%$exam_body%' AND `year` LIKE '%$subject_year%' AND `published` = 1 LIMIT $limit";
                    }
