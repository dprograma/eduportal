...
if (!empty(Session::get('loggedin'))) {
    ...
    $publications = $pdo->select("SELECT t.*, d.* FROM transactionlogs t, document d WHERE t.sku = d.sku AND t.user_id = '$currentUser->id' AND d.document_type = 'Publication'")->fetchAll(PDO::FETCH_ASSOC);
